package com.limurse.onboard.internal
...
import com.limurse.onboard.OnboardBase
import com.limurse.onboard.OnboardPageTransformerType
import com.limurse.onboard.OnboardViewPagerListener
import com.limurse.onboard.internal.viewpager.ViewPagerTransformer
import kotlin.math.max

/**
 * Class that controls the [ViewPager] of Onboard.
 ...
 */
internal class OnboardViewPager(context: Context, attrs: AttributeSet) : ViewPager(context, attrs) {

    var isFullPagingEnabled = true
    var isPermissionSlide = false
    var onNextPageRequestedListener: OnboardViewPagerListener? = null
    ...
    internal fun addOnPageChangeListener(listener: OnboardBase.OnPageChangeListener) {
    ...
    /**
     * Override is required to trigger [OnboardBase.OnPageChangeListener.onPageSelected] for the first page.
    ...
    fun setOnboardPageTransformer(OnboardTransformer: OnboardPageTransformerType) {
        setPageTransformer(true, ViewPagerTransformer(OnboardTransformer))
    }

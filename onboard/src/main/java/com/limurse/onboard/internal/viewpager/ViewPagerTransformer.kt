package com.limurse.onboard.internal.viewpager
...
internal class ViewPagerTransformer(
    private val transformType: OnboardPageTransformerType
    ...
    override fun transformPage(page: View, position: Float) {
        when (transformType) {
            OnboardPageTransformerType.Flow -> {
                page.rotationY = position * FLOW_ROTATION_ANGLE
            }
            OnboardPageTransformerType.SlideOver -> transformSlideOver(position, page)
            OnboardPageTransformerType.Depth -> transformDepth(position, page)
            OnboardPageTransformerType.Zoom -> transformZoom(position, page)
            OnboardPageTransformerType.Fade -> transformFade(position, page)
            is OnboardPageTransformerType.Parallax -> {

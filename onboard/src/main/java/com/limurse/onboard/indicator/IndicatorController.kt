package com.limurse.onboard.indicator
 ...
 * their behaviour. This is used for [Onboard.setCustomIndicator] and
 * [Onboard2.setCustomIndicator]
 */
interface IndicatorController {
    ...
    /**
     * Create a new instance of the view to be inserted in the Onboard layout.
     ...
     *
     * @param slideCount The amount of slides present in the Onboard
     */
